...
CV.findContours = function(imageSrc){
 ...
 var contours = [], 
  ...
  var boundingBox = { leftX:Infinity, rightX:0, topY:Infinity, bottomY:0 }; 
...
CV.boundingBox = function(contour){
  
 var boundingBox = {leftX:Infinity, rightX:0, topY:Infinity, bottomY:0 ,width:0, height:0};
 
 for(var i = 0;i<contour.length;i++){     
    if(contour[i].x < boundingBox.leftX)
                boundingBox.leftX = contour[i].x ;
            
    if(contour[i].x  > boundingBox.rightX)
                 boundingBox.rightX = contour[i].x;
             
    if(contour[i].y < boundingBox.topY)
                boundingBox.topY = contour[i].y;
            
    if(contour[i].y  > boundingBox.bottomY)
                 boundingBox.bottomY = contour[i].y;      
 }
 
 boundingBox.width = boundingBox.rightX - boundingBox.leftX;
 boundingBox.height = boundingBox.bottomY - boundingBox.topY;
